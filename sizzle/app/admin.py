...
from .models import Kursus, Resep, Teknik, Artikel, KategoriResep, KategoriKursus, KategoriTeknik, UserKursus, Pertemuan, KontenKursus, Tugas, Kuis, Bahan, UserKonten
